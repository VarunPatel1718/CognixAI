        ...
        <div className="mt-3 flex gap-3 flex-wrap sm:max-w-9/11">
          {articlelength.map((item, index) => (
            <span
              ...
              className={`text-xs px-4 py-1 rounded-full cursor-pointer ${selectedLength.text === item.text ? 'bg-violet-600/20 text-violet-300 border border-violet-500/30' : 'text-slate-400 border-slate-700'}`}
              key={index}
            >
              {item.text}
            </span>
