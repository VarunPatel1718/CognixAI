    ...
    return (
        <footer className='px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500 mt-20'>
            <div className='flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6'>
                <div className='md:max-w-96'>
                    ...
                    <p className='mt-6 text-sm'>
                        Experience the power of AI with CognixAI.<br />Transform your content creation with our suite of premium AI tools. Write articles, generate images, and optimize SEO effortlessly.
                    </p>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p className='text-center'>© {new Date().getFullYear()} <a href="https://prebuiltui.com">PrebuiltUI</a>. All rights reserved.</p>
